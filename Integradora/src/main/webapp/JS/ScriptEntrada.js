...
nuevoz2.addEventListener("click", () => {
    ...
    input.setAttribute("type", "text");
    input.setAttribute("name", "producto[]");
    input.setAttribute("id", "Producto" + j);
    input.setAttribute("placeholder", "Producto " + j);
    input.setAttribute("class", "form-control");
    input.setAttribute("required", "required");
    col1.appendChild(input);
    ...
    input2.setAttribute("type", "number");
    input2.setAttribute("name", "Cantidad[]");
    input2.setAttribute("id", "Cantidad" + j);
    input2.setAttribute("placeholder", "Cantidad " + j);
    input2.setAttribute("class", "form-control");
    col2.appendChild(input2);
    ...
    input3.setAttribute("type", "text");
    input3.setAttribute("name", "Precio[]");
    input3.setAttribute("id", "Precio" + j);
    input3.setAttribute("placeholder", "Precio " + j);
    input3.setAttribute("class", "form-control");
    col3.appendChild(input3);
    ...
    const button = document.createElement("a");
    button.innerHTML = svgString;
    button.setAttribute("name", "quitar" + j);
