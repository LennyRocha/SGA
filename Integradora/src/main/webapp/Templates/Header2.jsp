...
<header>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <ul class="dropdown-menu dropdown-menu-dark col" style="display:contents;">
            <li><p><a class="dropdown-item" href="InicioAlmacenista.jsp"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"/></svg> Menu principal</a></p></li>
            ...
            <li><hr class="dropdown-divider"></li>
            <li><p><a class="dropdown-item" href="pendientes.jsp"> <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#clock"/></svg> Pendientes</a></p></li>
            <li><hr class="dropdown-divider"></li>
        </ul>
        <hr>
